...
public slots:
    ...
    QUrl createLink(const QString &localFile, const QString command);
...
private:
    ...
    // Unsupported by the Files.fm server
    ...
    Q_INVOKABLE void command_ASK_TO_UNLOCK_FILE(const QString &localFile, OCC::SocketListener *listener);
