...
public:
    ...
    Q_INVOKABLE void resultClicked(const QString &remotePath) const;
    Q_INVOKABLE void fetchMoreTriggerClicked(const QString &providerId);
    Q_INVOKABLE void revealInFileManager(const QString &localFullPath) const;
...
QString resolveLocalFullPathForRemote(const QString &remotePath, AccountState *accountState);
