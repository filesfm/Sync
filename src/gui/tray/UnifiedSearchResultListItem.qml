...
MouseArea {
    ...
    property var revealInFileManager: function(){}
    ...
    Rectangle {
        ...
        anchors.fill: parent
        color: parent.containsMouse ? "#e6e6e6" : "transparent"
    }
    ...
    Loader {
        ...
        sourceComponent: UnifiedSearchResultItem {
            ...
            resourceUrl: model.resourceUrlRole
            rootDir: model.rootDirRole
	        syncDirectories: model.syncDirectories
            onRevealInFileManager: unifiedSearchResultMouseArea.revealInFileManager(localFullPath)
        }
    }
    ...
    onClicked: {
        if (isFetchMoreTrigger) {
            ...
            unifiedSearchResultMouseArea.resultClicked(model.subline)
        }
    }
}
