...
Button {
    ...
    Menu {
        ...
        x: root.x - 5
        y: (root.y + Style.trayWindowHeaderHeight - 5)
        ...
        background: Rectangle {
            // Force opaque
            color: Qt.rgba(palette.base.r, palette.base.g, palette.base.b, 1.0)
        ...
        MenuItem {
            ...
            icon.source: "image://svgimage-custom-color/add-account.svg/" + palette.windowText
            icon.width: Style.accountAvatarSize - 12
            icon.height: Style.accountAvatarSize - 12
    ...
    RowLayout {
        ...
        Column {
            ...
            EnforcedPlainTextLabel {
                ...
                font.pixelSize: Style.topLinePixelSize + 2
                font.bold: true
            }
