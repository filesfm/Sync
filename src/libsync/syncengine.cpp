...
void SyncEngine::startSync()
{
    ...
    // Clean up records marked for pending delete from previous sync cycle
    // This allows move detection to work across sync cycles by keeping inode records
    // available for one additional sync after remote deletion
    _journal->cleanupPendingDeletes();
