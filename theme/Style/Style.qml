...
QtObject {
    ...
    property int trayWindowWidth: variableSize(500)
    ...
    property int currentAccountButtonWidth: 210
    ...
    property int accountAvatarSize: (trayWindowHeaderHeight - 24)
    ...
    property int accountDropDownCaretSize: 16
